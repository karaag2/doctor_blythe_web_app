...
const Hero = () => {
	return (
		<div className="flex flex-col bg-white max-w-screen overflow-hidden">
			{/* <TopBar /> */}
			<div className="-top-22 -right-1/5 sm:left-4/9 md:left-1/2 lg:left-3/5 xl:left-3/4 relative bg-gradient-to-b from-blue-500 to-blue-200 pt-7 rounded-b-full w-fit rotate-45 xl:scale-120 md:max-lg:translate-x-12 xl:-translate-x-24">
