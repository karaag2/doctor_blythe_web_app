...
const Hero = () => {
	return (
		<div className="relative flex flex-col max-w-screen overflow-hidden">
			...
			<div className="top-1/16 right-1/24 absolute bg-white hover:bg-blue-800 dark:bg-blue-600 dark:hover:bg-blue-700 me-2 mb-px px-5 py-2 rounded-xl focus:outline-none focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-800 font-[Montserrat] font-medium text-blue-500 text-xs xs:text-sm text-center cursor-pointer amdow -1">
				Rendez-vous
			</div>
		</div>
	);
